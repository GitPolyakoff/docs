...
When you translate or update a translation, **copy the `version` from the current English page** and set `lastUpdated` to today's date. A translation whose version matches the English page shows as **Current** on the [Translation Status](/guides/translation-status/) page; a mismatch shows as **Outdated** and displays a notice banner on the translated page. Both fields are required — the CI check will fail a pull request that omits them.
...
Translators and contributors are credited on the [Contributors](/guides/contributors/) page. Thank you for helping make TrucklineMP accessible to everyone!
